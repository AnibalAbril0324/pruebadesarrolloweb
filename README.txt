...
a persistence unit "eva62AbrilPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62Abril/pom.xml":
...
artifact ("eva62Abril.war") is already built. You can build
